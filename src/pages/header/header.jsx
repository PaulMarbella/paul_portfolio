  ...
  return (
    <nav className="navbar navbar-expand-lg sticky-top">
      <div className="container-fluid px-3">
        <a className="navbar-brand logo ms-5" href="#">
          PAUL <span>JR.</span>
        </a>
        ...
        <div
          className={`collapse navbar-collapse collapse-item ${
            isNavOpen ? "show" : ""
          }`}
          id="navbarNav"
        >
          <div className="d-flex flex-wrap justify-content-center w-100 nav-items">
          ...
          <div className="d-flex align-items-center justify-content-center gap-2 mt-3 me-5 mt-lg-0">
